...
function Disclaimer() {
  return (
    <section className=' bg-brand-grey m-10  md:pb-20 md:pt-20 md:pl-20 md:pr-20 rounded-3xl my-24 text-brand-primary'>
       
      <div className='p-5 font-medium text-tiny md:text-2xl mt-6 text-center'>
        <p className='mb-6'>
